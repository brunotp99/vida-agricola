...
export const metadata = { title: "Featured Products | Vida Agrícola" }
        ...
        <div className="border-b border-border bg-muted">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="font-medium text-foreground">Featured Products</span>
            </nav>
          </div>
        </div>
        ...
        <div className="bg-card py-8">
          <div className="container mx-auto px-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-foreground md:text-4xl">Featured Products</h1>
                <p className="text-muted-foreground">Handpicked selection of premium products</p>
              </div>
            </div>
          </div>
        </div>
