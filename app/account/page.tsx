            ...
            <aside className="lg:col-span-1">
              <Card className="border-border">
                <CardContent className="p-6">
                  ...
                  <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-destructive hover:bg-destructive/10">
                    ...
                    {addresses.map((address) => (
                      <Card
                        ...
                        className={`border-border ${
                          address.default ? 'ring-2 ring-primary' : ''
                        }`}
                      >
                        <CardContent className="p-6">
