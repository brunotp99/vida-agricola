...
export const metadata = { title: "New Arrivals | Vida Agrícola" }
        ...
        <div className="bg-card py-8">
          <div className="container mx-auto px-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-foreground md:text-4xl">New Arrivals</h1>
                <p className="text-muted-foreground">Fresh additions to our product range</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4">
            {products.length > 0 ? (
              ...
              <div className="rounded-lg border border-border bg-card p-16 text-center">
                ...
                <p className="text-lg text-muted-foreground">No new arrivals at the moment. Check back soon!</p>
              </div>
            )}
          </div>
        </div>
